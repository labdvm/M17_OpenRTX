...
void                recordMic(uint16_t *buffer)
{
     ...
     * AP1 frequency is 42MHz but timer runs at 84MHz, configure for 8kHz
     * interrupt rate.
     */
    ...
    ADC1->SMPR2 =
        ADC_SMPR2_SMP0 | ADC_SMPR2_SMP1 | ADC_SMPR2_SMP3 | ADC_SMPR2_SMP8;
    ...
    ADC1->CR2 |= ADC_CR2_EXTEN_0 /* Trigger on rising edge        */
               ...
               | ADC_CR2_DMA | ADC_CR2_ADON; /* Enable ADC                    */
