...
static constexpr syncw_t STREAM_SYNC_WORD = {0xFF, 0x5D}; // Stream data sync
                                                          // word
static constexpr syncw_t PACKET_SYNC_WORD = {0x75, 0xFF}; // Packet data sync
                                                          // word
static constexpr syncw_t EOT_SYNC_WORD = {0x55, 0x5D};    // End of transmission
                                                          // sync word
