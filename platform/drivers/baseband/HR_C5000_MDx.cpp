...
static const uint8_t initSeq3[] = {
    0x01, 0x10, 0x69, 0x69, 0x96, 0x96, 0x96, 0x99, 0x99, 0x99, 0xA5,
    0xA5, 0xAA, 0xAA, 0xCC, 0xCC, 0x00, 0xF0, 0x01, 0xFF, 0x01, 0x0F};
...
void HR_Cx000<M>::fmMode()
{
    ...
    writeReg(M::CONFIG, 0x0E, 0x40 | 0x04); // Set the mic input during early
                                            // init, if we don't the "frequency
                                            // wiggle" is present
}
